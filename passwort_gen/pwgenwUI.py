...
def number():
    pass
titlelable = ctk.CTkLabel(window, text="Password Generator V2", font=("Arial", 20))
...
pnc = IntVar()
checkboxPun = ctk.CTkCheckBox(master=frame, 
                           text="Punctuation", 
                           command=punctuation, 
                           variable=pnc,
                           onvalue=1,
                           offvalue=0,)
checkboxPun.pack(pady=12, padx=10)

nmb = IntVar()
checkboxNum = ctk.CTkCheckBox(master=frame, 
                           text="Numbers", 
                           command=number, 
                           variable=nmb,
                           onvalue=1,
                           offvalue=0,)
checkboxNum.pack(pady=12, padx=10)


window.mainloop() #temp
#----------------
def space(strings):
