...
At the end of the if statement, I asked if not isinstance(nr1, float) or not isinstance(nr2, float). 
This statement basically checks if the instance of nr1 or nr2 is a floating-point number.
